import type { Client, InventoryItem, Job, ServiceRequest, Site, Technician, User } from "./types.js";
...
export const seededTechnicians: Technician[] = [
  {
    id: "tech-1",
    userId: "user-tech-1",
    employeeId: "SSE-T001",
...
export const seededInventoryItems: InventoryItem[] = [
  {
    id: "inv-1",
    sku: "CAM-DOME-4MP",
...
export const seededServiceRequests: ServiceRequest[] = [
  {
    id: "req-1",
    clientId: "client-1",
    siteId: "site-1",
